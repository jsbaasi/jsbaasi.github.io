...
don't try to stream blobs through application server, will just exhause memory of the server. instead blob services like s3 (simple storage service) and gcp buckets 
